    ...
    if event.postback.data == '1a':  
        ...
        columns=[
            CarouselColumn(
                ...
                text='之後你們也時常一起聊天，關係變得更好了。訂單成功，是否要重新開始遊戲？',
        ...
        columns=[
            CarouselColumn(
                ...
                text='隔天校方公佈賣辣炒年糕的班級有人是新冠肺炎無症狀確診者，很不幸的你們兩個吃完後都中標了。訂單失敗，是否要重新開始遊戲？',
                thumbnail_image_url='https://raw.githubusercontent.com/jennifer1214/ivanbot/main/%E5%A4%B1%E6%95%97.png',
                actions=[
                    PostbackAction(
                            label='是',
        ...
        columns=[
            CarouselColumn(
                ...
                text='之後陽光同學似乎因為你球踢得好，一直把你當兄弟TAT。訂單失敗，是否要重新開始遊戲？',
                thumbnail_image_url='https://raw.githubusercontent.com/jennifer1214/ivanbot/main/%E5%A4%B1%E6%95%97.png',
                actions=[
                    PostbackAction(
                            label='是',
        ...
        columns=[
            CarouselColumn(
                ...
                text='陽光同學接受不了，好感度歸零。訂單失敗，是否要重新開始遊戲？',
                thumbnail_image_url='https://raw.githubusercontent.com/jennifer1214/ivanbot/main/%E5%A4%B1%E6%95%97.png',
                actions=[
                    PostbackAction(
                            label='是',
        ...
        columns=[
            CarouselColumn(
                ...
                text='最後沒有跟陽光同學增近到感情。訂單失敗，是否要重新開始遊戲？',
                thumbnail_image_url='https://raw.githubusercontent.com/jennifer1214/ivanbot/main/%E5%A4%B1%E6%95%97.png',
                actions=[
                    PostbackAction(
                            label='是',
        ...
        columns=[
            CarouselColumn(
                ...
                text='之後陽光同學也會時不時的約你出去。訂單成功，是否要重新開始遊戲？',
                thumbnail_image_url='https://raw.githubusercontent.com/jennifer1214/ivanbot/main/%E6%88%90%E5%8A%9F.png',
                actions=[
                    PostbackAction(
                            label='是',
...
#路線二結尾
        ...
        columns=[
            CarouselColumn(
                ...
                text='鄰座的同學表示感謝你當初的明智之舉，之後你們反而變得更親密～訂單成功，是否要重新開始?',
                thumbnail_image_url='https://raw.githubusercontent.com/jennifer1214/ivanbot/main/%E6%88%90%E5%8A%9F.png',
                actions=[
                    PostbackAction(
                            label='是',
